...
btn_write.addEventListener("click", () => {
  self.location.href = "./free_board_write.php";
});
...
btn_search.addEventListener("click", () => {
  ...
  if (date_from.value != "" && date_to.value != "") {
    ...
    self.location.href =
      "./free_board_list.php?" + "sn=" + sn.value + "&sf=" + sf.value;
  }
});
...
btn_all.addEventListener("click", () => {
  self.location.href = "./free_board_list.php";
});
...
trs.forEach((box) => {
  box.addEventListener("click", () => {
    self.location.href = "./free_board_view.php?" + "idx=" + box.dataset.idx;
  });
});
